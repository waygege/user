<template lang="html">
  ...
  <div class="car">
    ...
    <router-link :to="{name:'用户信息页',query:{object:this.user}} ">
    <header class="header" v-if="image" >
      <div class="header-icon" >
      <img v-if="user.avatar" :src="user.avatar" style="border-radius:50%;width: 100%;height:100%;" />
      </div>
      ...
      <div class="main">
          <router-link class="my-indent" :to="{ name: '订单信息'}">
              <span class="my-indent-left">我的支付</span>
          ...
          <section class="my-vip">
            <router-link class="my-vip-top ho" :to="{ name: '兑换优惠卷'}" >
              ...
              <p>
                <span>兑换优惠卷</span><i class="icon-go"></i>
              </p>
            </router-link>
            <router-link class="my-vip-bottom ho" :to="{ name: '优惠卷页'}">
              <div>
                <span class="icon2-money"></span>
              </div>
              <p>
                <span>我的优惠卷</span><i class="icon-go"></i>
              </p>
            </router-link>
        ...
        <section class="my-service" @click="logout">
          <router-link class="my-vip-bottom ho" :to="{ name: ''}">
                  <p>
                    <span alert="center" >退出登录</span>
                  </p>
          </router-link>
  ...
  export default {
    ...
    beforeMount(){
      ...
      if(sessionStorage.getItem("username")==undefined
        ...
        this.$api({
          method: 'get',
          url: '/findByUsername?userName='+sessionStorage.getItem("username")
        }).then((res) => {
