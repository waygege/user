<template lang="html">
  ...
  <div class="index">
    ...
    <v-service/>
    <!--<v-section1 :list="datas" />&lt;!&ndash;:banner='datas.images'&ndash;&gt;-->
    <!--<v-section2 :list="datas.section2" />&lt;!&ndash;:banner='datas.section2.banner&ndash;&gt;-->
   <!-- <v-section3/>- -->
     <v-section4 :list='datas.section4' />
     <v-baseline/>
    <v-footer/>
  </div>
</template>
...
export default {
  ...
  beforeCreate() {
    this.$api({
      method: 'post',
      url: '/dish/findHotDish'
    }).then((response) => {
      this.datas.section4 = response.data;
